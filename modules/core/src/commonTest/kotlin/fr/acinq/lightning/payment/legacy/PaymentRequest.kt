package fr.acinq.lightning.payment.legacy
...
//        require(tags.filterIsInstance<TaggedField.PaymentSecret>().size == 1) { "there must be exactly one payment secret tag" }
    ...
    companion object {
        ...
        private val prefixes = mapOf(
            Block.RegtestGenesisBlock.hash.value to "lnbcrt",
            Block.Testnet3GenesisBlock.hash.value to "lntb",
            Block.LivenetGenesisBlock.hash.value to "lnbc"
        )
